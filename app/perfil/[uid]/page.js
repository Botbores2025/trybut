    ...
    try {
      if (tipo === "adicionar") {
        await enviarSolicitacao(
          user.uid, meuPerfil?.nome, meuPerfil?.fotoURL,
          uid, perfil?.nome, perfil?.fotoURL
        );
        setRelacao("enviada");
          ...
          <div style={{ flex: 1 }}>
            ...
            {ehMeu ? (
              ...
              <div className="perfil-botoes">
                ...
                {relacao === "recebida" && (
                  <>
                    <button className="btn-seguir" onClick={() => acaoAmizade("aceitar")} disabled={carregandoAcao}>
                      aceitar
                    </button>
                    <button className="btn-msg" onClick={() => acaoAmizade("recusar")} disabled={carregandoAcao}>
                      recusar
                    </button>
                  </>
                )}
